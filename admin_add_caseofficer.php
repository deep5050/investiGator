...
?>
                            ...
                            $sql="SELECT  Case_Id,Officer_Id FROM `assigns` WHERE 1";
                                              //  echo $sql;
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Add Case Officer</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2"></h3>
                                        </div>
                                        <hr>
                                        <form action="./checkings/admin/add_caseofficer.php"  method="post" novalidate="novalidate" enctype="multipart/form-data">
                                          
                                            
                                           <?php

                    $sql="SELECT Case_Id FROM `case` WHERE Admin_Id='{$admin_id}'";
                        //echo $sql;
                    $result = mysqli_query($conn, $sql);
                    ...
                    $sql="SELECT Officer_Id FROM `officer` WHERE 1";
                    echo ' <select name="officer_id">';
                    $result = mysqli_query($conn, $sql);
...
document.location='admin_add_caseofficer.php';
})
</script>";
mysqli_close($conn);
?>
